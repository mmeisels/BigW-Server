...
// App modules
    ...
    products-cat = require('./server/products-cat'),
...
app.get('/products-cat', auth.validateToken, products.getAll);
app.get('/products-cat/:id', auth.validateToken, products.getById);
